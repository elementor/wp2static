...
class StaticHtmlOutput_S3 {
     ...
     * @return void
     */
    public function create_s3_deployment_list(
        $dir,
        $archiveName,
        $remotePath
    ) {
    ...
    public function get_item_to_export() {
        ...
        /**
         * TODO reduce the 2 file reads here, this one is just trimming
         * TODO ... the first line
         */
     ...
     * @param object $pluginInstance Instance of $this
     * @return void
     */
    public function s3_put_object(
        ...
        /**
         * Use of $pluginInstance
         *
         * @leonstafford - Any particular reason we need $this within $this?
         */
        if ( wpsho_fr()->is__premium_only() ) {
            ...
            try {
                ...
                error_log( $e );
                /**
                 * $pluginInstance->wsLog(
                 *     'S3 EXPORT: following error returned from S3:'
                 * );
                 */
