...
class StaticHtmlOutput_FTP {
     ...
     * @param boolean $activeMode  Active mode flag
     ...
     *
     * @return void
     * @throws Exception If conneciton fails
     */
    ...
    public function create_ftp_deployment_list(
        ...
        /**
         * TODO: move this to a parent class as identical to bunny and probably
         * TODO: ... others
         */
        $files = scandir( $dir );
            ...
            if ( $item != '.' && $item != '..' && $item != '.git' ) {
                if ( is_dir( $dir . '/' . $item ) ) {
                    $this->create_ftp_deployment_list(
                        $dir . '/' . $item, $archiveName, $remotePath
                    );
     ...
     * Transfer files
     *
     * @param boolean $viaCLI CLI transfer flag
     * @return void
     * @throws Exception If FTP authentication fails
     */
