...
<div class="tablenav-pages">
    ...
    <span class="pagination-links">
        ...
        <?php else: ?>
            ...
            <a class="prev-page button" href="<?php echo \WP2Static\URLHelper::modifyUrl(['paged' => $this->page() - 1]); ?>"><span class="screen-reader-text">Previous page</span><span aria-hidden="true">‹</span></a>
        <?php endif; ?>
        ...
        <?php if ($this->page() === $this->lastPage()): ?>
            ...
            <span class="tablenav-pages-navspan button disabled" aria-hidden="true">»</span>
        <?php else: ?>
            <a class="next-page button" href="<?php echo \WP2Static\URLHelper::modifyUrl(['paged' => $this->page() + 1]); ?>"><span class="screen-reader-text">Next page</span><span aria-hidden="true">›</span></a>
            <a class="last-page button" href="<?php echo \WP2Static\URLHelper::modifyUrl(['paged' => $this->lastPage()]); ?>"><span class="screen-reader-text">Last page</span><span aria-hidden="true">»</span></a>
        <?php endif; ?>
    </span>
</div>