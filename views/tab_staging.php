<div id="staging_deploy" v-show="currentTab == 'staging_deploy'">
...
<section class="wp2static-content wp2static-flex">
  ...
  <div class="content">
    <select id="selected_deployment_method" name="currentDeploymentMethod" v-model="currentDeploymentMethod">
