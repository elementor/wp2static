...
jQuery(document).ready(function ($) {
    ...
    function loadLogFile() {
        ...
        // load the log file
        $.get(logFileUrl + '?cacheBuster=' + Date.now(), function (data) {
            // hide loading icon
    ...
    function changeTab(targetTab) {
        ...
        $.each($('.nav-tab'), function (index, element) {
    ...
    $(document).on('click', '#GoToDetectionTabButton', function (evt) {
        evt.preventDefault();
    ...
    $('.wrap').on('click', '[id$="-test-button"]', function (event) {
        event.preventDefault();
        spinner = $('button').siblings('div.spinner');
        spinner.show();
